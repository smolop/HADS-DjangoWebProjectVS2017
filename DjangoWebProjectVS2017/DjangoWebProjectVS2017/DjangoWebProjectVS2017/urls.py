...
urlpatterns = [
    ...
    url(r'^admin/', include(admin.site.urls)),
     url(r'^polls/add_topic/', app.views.topic_new, name='add_topic'),
    ...
    url(r'^polls/questions/(?P<topic_id>\d+)/$', app.views.poll, name='polls'),
     url(r'^polls/(?P<question_id>\d+)/$', app.views.detail, name='detail'),
    url(r'^polls/(?P<question_id>\d+)/option/$', app.views.option, name='option'),
